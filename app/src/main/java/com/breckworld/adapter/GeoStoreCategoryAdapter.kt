...
class GeoStoreCategoryAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        try {
            holderType.imageViewForTabBorder.setBackgroundTintList(
        ...
        holderType.textViewTitle.alpha = colors?.tab_opacity?.toFloat()!!
        holderType.imageViewForTabBorder.alpha = colors?.tab_border_opacity?.toFloat()!!
    ...
    inner class ViewHolderForNewUser(view: View) : RecyclerView.ViewHolder(view) {
        ...
        var layoutBorder: FrameLayout = itemView.findViewById(R.id.layoutBorder)
        var imageViewForTabBorder: ImageView = itemView.findViewById(R.id.imageViewForTabBorder)
    }
    ...
    fun updateCount(selectedTabPosition: Int, tabCount: Int) {
        categoryList.get(selectedTabPosition).tab_count = tabCount
        notifyDataSetChanged()
    }
