...
public class NumberPicker extends LinearLayout {
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        this.incrementButton.setBackgroundColor(getResources().getColor(R.color.colorTransparent));
        this.decrementButton.setBackgroundColor(getResources().getColor(R.color.colorTransparent));
        this.incrementButton.setTextColor(getResources().getColor(R.color.colorLightGray));
        this.decrementButton.setTextColor(getResources().getColor(R.color.colorLightGray));
