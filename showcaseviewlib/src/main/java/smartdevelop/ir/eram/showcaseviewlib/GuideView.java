...
public class GuideView extends FrameLayout {
    ...
    private Point resolveMessageViewLocation() {
        ...
        if (isTop || targetRect.top + (indicatorHeight) > getHeight() / 2) {
    ...
    public void setPositionMessageView(Boolean isTop) {
        this.isTop = isTop;
    }
    ...
    public void isCintentTextVisible(Boolean isVisible) {
        mMessageView.isTextVisibility(isVisible);
    }
    ...
    public static class Builder {
        ...
        public Builder setsetPositionMessageView(Boolean isTop) {
            this.isTop = isTop;
            return this;
        }
        ...
        public GuideView build() {
            ...
            if (isTop != null) {
                guideView.setPositionMessageView(isTop);
            }
            if (contentText != null) {
                guideView.setContentText(contentText);
            } else {
                guideView.isCintentTextVisible(false);
            }
            if (titleTextSize != 0)
